...
exports.createTables = function(){
  ...
  con.connect(function(err)
  {
    ...
    var UserInfo = "USE peoplehealth; CREATE TABLE IF NOT EXISTS Users (User_ID INT (3) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, FirstName VARCHAR (20) NOT NULL, LastName VARCHAR (20) NOT NULL, Email VARCHAR (20) NOT NULL, Username VARCHAR (10) NOT NULL, Password VARCHAR (20) NOT NULL);";
    var UserLogin = "USE peoplehealth; CREATE TABLE IF NOT EXISTS User_Logins (User_ID INT (3) UNSIGNED NOT NULL, Username VARCHAR (10) NOT NULL, Password VARCHAR (20) NOT NULL, FOREIGN KEY (User_ID) REFERENCES Users(User_ID));";
